...
| `hiv_pos_pct` | positivos / (positivos + negativos) | **idêntica** | PE 2024: 13,9% dos dois lados. A proporção bate; o denominador exibido, não — ver a linha abaixo. | 2026-08-07 |
| Contagens de `sinan_landing` | soma o dataset inteiro | soma só `sexo='TOTAL'` | **Estamos certos e eles não.** A linha TOTAL já é a soma de M, F e I — conferido em 9,97 milhões de combinações, sem exceção. Somar tudo dobra. Em PE 2024 os dois painéis mostravam "1.034 de 8.700" quando o correto é 517 de 4.350. A proporção nunca sentiu, porque numerador e denominador dobravam juntos, e foi por isso que o defeito sobreviveu à comparação. Nossas contagens agora são metade das deles, de propósito. | 2026-08-08 |
...
| — encerramentos no denominador | 4.350 | 8.700 | **eles dobram** |
| — testados (HIV) | 4.125 | 8.250 | **eles dobram** |
